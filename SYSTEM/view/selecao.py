...
class Selecao:
    def __init__(self):
        ...
        btnTreino.place(x=240,y=170,width=100,height=25)
        ...
        btnPerfil.place(x=240,y=230,width=100,height=25)
        ...
        self.labelInicial["justify"] = "center"
        ...
        btnComunidade.place(x=240,y=110,width=100,height=25)
